...
echo '<table><tr><th>Event Name</th></tr><form action="delevents.php" method="GET">';
while($row = $in->fetch(PDO::FETCH_ASSOC)){
$val = $row['id'];
echo '<tr><td><input type="checkbox" name="checkbox[]" id="eventid" value="' . $val . '"/>';
echo  ($row['eventname']);
}
echo "</table><ul  class=\"form-style-1\"> <li>";

echo     "
        <input type=\"submit\"  name=\"action\" id=\"eventid\" value=\"Delete Selected Events\" />      
    </li></ul></form></body>";
echo"</html>";
?>